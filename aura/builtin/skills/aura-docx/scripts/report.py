#!/usr/bin/env python3
"""
Assemble a report.json for aura_docx following references/aura_report_schema.md.
"""
...
def build_report(
    *,
    ...
    return {
        ...
        "gates": {
            "gate_a": gate_a,
            "gate_b": {"required": False, "skipped": False, "ok": None, "reason": "N/A for docx"},
        },
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Build aura_docx report.json")
